...
sealed unsafe class MyApplication : Application
{
    ...
    private          MsdfFont             _msdfFont2   = null!;
    ...
    protected override void OnLoadContent()
    {
        ...
        _msdfFont2   = _contentManager.Load<MsdfFont>(MsdfFonts.ARIAL, true);
    }
    ...
    protected override void OnUnloadContent()
    {
        ...
        _contentManager.Unload<MsdfFont>(MsdfFonts.ARIAL);
    }
    ...
    protected override void Render(Time time)
    {
        ...
        if (_renderer.Begin(out VkCommandBuffer commandBuffer))
        {
            ...
            {
                _canvas.RenderArc(
                    new Arc2(new Vector2(rnd.Next(150, 900), rnd.Next(150, 600)), rnd.Next(60, 200) + 50 * MathF.Sin(time.TotalTimeS), rnd.NextSingle() * MathF.PI * 2f,
                        rnd.NextSingle()                                                                                                                * MathF.PI * 2f),
                    20f,
