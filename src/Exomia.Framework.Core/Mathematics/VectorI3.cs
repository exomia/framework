...
namespace Exomia.Framework.Core.Mathematics
{
    ...
    {
        /// <summary> A <see cref="VectorI3" /> with all of its components set to zero. </summary>
        public static readonly VectorI3 Zero = new VectorI3(0, 0, 0);

        /// <summary> The X unit <see cref="VectorI3" /> (1, 0, 0). </summary>
        public static readonly VectorI3 UnitX = new VectorI3(1, 0, 0);

        /// <summary> The Y unit <see cref="VectorI3" /> (0, 1, 0). </summary>
        public static readonly VectorI3 UnitY = new VectorI3(0, 1, 0);

        /// <summary> The Z unit <see cref="VectorI3" /> (0, 0, 1). </summary>
        public static readonly VectorI3 UnitZ = new VectorI3(0, 0, 1);

        /// <summary> A <see cref="VectorI3" /> with all of its components set to one. </summary>
        ...
        /// <summary> Initializes a new instance of the vector3 struct. equal to <see cref="VectorI3" /> (value.x, value.y, 0) </summary>
        ...
        /// <summary> Determines whether the specified <see cref="VectorI3" /> is equal to this instance. </summary>
        /// <param name="other"> The <see cref="VectorI3" /> to compare with this instance. </param>
        /// <returns> <c>true</c> if the specified <see cref="VectorI3" /> is equal to this instance; <c>false</c> otherwise. </returns>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="int" /> to <see cref="VectorI3" />. equal to
        ///     <see cref="VectorI3" /> (value)
        /// </summary>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="int" /> to <see cref="VectorI3" />. equal to
        ///     <see cref="VectorI3" /> (value.x, value.y, 0)
        /// </summary>
        /// <param name="value"> The value. </param>
        /// <returns> The result of the conversion. </returns>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="VectorI3" /> to <see cref="Vector3" />. equal to
        ///     <see cref="Vector3" /> (value.x, value.y, value.z)
        /// </summary>
        /// <param name="value"> The value. </param>
        /// <returns> The result of the conversion. </returns>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="Vector3" /> to <see cref="VectorI3" />. equal to
        ///     <see cref="VectorI3" /> ((int)value.x, (int)value.y, (int)value.z)
        /// </summary>
        /// <param name="value"> The value. </param>
        /// <returns> The result of the conversion. </returns>
