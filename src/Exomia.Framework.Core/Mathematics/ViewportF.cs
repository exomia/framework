...
/// <summary> Defines the viewport dimensions using float coordinates for (X,Y,Width,Height). </summary>
...
public struct ViewportF
{
    ...
    /// <summary> Initializes a new instance of the <see cref="ViewportF" /> struct. </summary>
