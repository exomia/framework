...
namespace Exomia.Framework.Core.Mathematics.Extensions.Vector
{
    ...
    public static class Vector2Extensions
    {
        ...
        /// <summary> Calculates the horizontal angle of a <see cref="Vector2" />. </summary>
        /// <param name="vec"> This <see cref="Vector2" />. </param>
        /// <returns> The angle horizontal. </returns>
        ...
        /// <summary> Calculates the vertical angle of a <see cref="Vector2" />. </summary>
        /// <param name="vec"> This <see cref="Vector2" />. </param>
        /// <returns> The angle vertical. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
