...
namespace Exomia.Framework.Core.Input
{
    ...
    public interface IInputDevice
    {
        ...
        /// <summary>
        ///     Unregister the raw key event described by handler.
        /// </summary>
        /// <param name="handler"> The handler. </param>
        void UnregisterRawKeyEvent(RawKeyEventHandler handler);

        /// <summary>
        ///     Unregister the key up described by handler.
        /// </summary>
        /// <param name="handler"> The handler. </param>
        void UnregisterKeyUp(KeyEventHandler handler);

        /// <summary>
        ///     Unregister the key press described by handler.
        /// </summary>
        /// <param name="handler"> The handler. </param>
        void UnregisterKeyPress(KeyPressEventHandler handler);

        /// <summary>
        ///     Unregister the key down described by handler.
        /// </summary>
        /// <param name="handler"> The handler. </param>
        ...
        /// <summary>
        ///     Unregister the mouse up described by handler.
        /// </summary>
        /// <param name="handler"> The handler. </param>
        void UnregisterMouseUp(MouseEventHandler handler);

        /// <summary>
        ///     Unregister the mouse click described by handler.
        /// </summary>
        /// <param name="handler"> The handler. </param>
        void UnregisterMouseClick(MouseEventHandler handler);

        /// <summary>
        ///     Unregister the mouse move described by handler.
        /// </summary>
        /// <param name="handler"> The handler. </param>
        void UnregisterMouseMove(MouseEventHandler handler);

        /// <summary>
        ///     Unregister the mouse wheel described by handler.
        /// </summary>
        /// <param name="handler"> The handler. </param>
