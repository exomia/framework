...
{
    /// <summary> An allocator. This class cannot be inherited. </summary>
    public sealed unsafe class Allocator : IDisposable
    {
        ...
        public Allocator(uint maxBufferCount = DEFAULT_MAX_MEMORY_COUNT)
        {
        ...
        /// <summary> Finalizes an instance of the <see cref="Allocator" /> class. </summary>
        ~Allocator()
        {
            Dispose();
        }
