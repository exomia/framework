...
namespace Exomia.Framework.Core.Vulkan.Configurations
{
    ...
    {
        public VkPipelineInputAssemblyStateCreateFlagBits Flags                  { get; set; } = VkPipelineInputAssemblyStateCreateFlagBits.Reserved;
        public VkPrimitiveTopology                        Topology               { get; set; } = VkPrimitiveTopology.TRIANGLE_LIST;
    ...
    {
        public VkPipelineRasterizationStateCreateFlagBits Flags                   { get; set; } = VkPipelineRasterizationStateCreateFlagBits.Reserved;
        public VkBool32                                   DepthClampEnable        { get; set; } = VkBool32.False;
        public VkBool32                                   RasterizerDiscardEnable { get; set; } = VkBool32.False;
        public VkPolygonMode                              PolygonMode             { get; set; } = VkPolygonMode.FILL;
        public VkCullModeFlagBits                         CullMode                { get; set; } = VkCullModeFlagBits.BACK_BIT;
        public VkFrontFace                                FrontFace               { get; set; } = VkFrontFace.CLOCKWISE;
    ...
    {
        public VkPipelineMultisampleStateCreateFlagBits Flags                 { get; set; } = VkPipelineMultisampleStateCreateFlagBits.Reserved;
        public VkSampleCountFlagBits                    RasterizationSamples  { get; set; } = VkSampleCountFlagBits._1_BIT;
    ...
    {
        public VkPipelineDepthStencilStateCreateFlagBits Flags                 { get; set; } = VkPipelineDepthStencilStateCreateFlagBits.Reserved;
        public VkBool32                                  DepthTestEnable       { get; set; } = VkBool32.True;
        public VkBool32                                  DepthWriteEnable      { get; set; } = VkBool32.True;
        public VkCompareOp                               DepthCompareOp        { get; set; } = VkCompareOp.LESS;
    ...
    public sealed class ColorBlendAttachmentConfiguration
    {
        ...
        public VkBlendFactor SrcColorBlendFactor { get; set; } = VkBlendFactor.SRC_ALPHA;
        public VkBlendFactor DstColorBlendFactor { get; set; } = VkBlendFactor.ONE_MINUS_SRC_ALPHA;
        public VkBlendOp     ColorBlendOp        { get; set; } = VkBlendOp.ADD;
        public VkBlendFactor SrcAlphaBlendFactor { get; set; } = VkBlendFactor.ONE;
        public VkBlendFactor DstAlphaBlendFactor { get; set; } = VkBlendFactor.ZERO;
        public VkBlendOp     AlphaBlendOp        { get; set; } = VkBlendOp.ADD;

        public VkColorComponentFlagBits ColorWriteMask { get; set; } =
            VkColorComponentFlagBits.R_BIT | VkColorComponentFlagBits.G_BIT | VkColorComponentFlagBits.B_BIT | VkColorComponentFlagBits.A_BIT;
    }

    /// <summary> A color blend configuration. This class cannot be inherited. </summary>
    public sealed class ColorBlendConfiguration
    {
        public VkPipelineColorBlendStateCreateFlagBits Flags         { get; set; } = VkPipelineColorBlendStateCreateFlagBits.Reserved;
        public VkBool32                                LogicOpEnable { get; set; } = VkBool32.False;
        public VkLogicOp                               LogicOp       { get; set; } = VkLogicOp.NO_OP;
    }
    ...
    {
        public VkPipelineCreateFlagBits Flags   { get; set; } = VkPipelineCreateFlagBits.ALLOW_DERIVATIVES_BIT;
