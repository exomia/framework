...
namespace Exomia.Framework.Win32
{
    static class WS
    {
        ...
        /// <summary>
        /// Clips child windows relative to each other; that is; when a particular child window receives a WM_PAINT message; the public const uint CLIPSIBLINGS style clips all other overlapping child windows out of the region of the child window to be updated.
        /// If public const uint CLIPSIBLINGS is not specified and child windows overlap; it is possible; when drawing within the client area of a child window; to draw within the client area of a neighboring child window.
        /// </summary>
        ...
        /// <summary>
        /// The window is the first control of a group of controls. The group consists of this first control and all controls defined after it; up to the next control with the public const uint GROUP style.
        /// The first control in each group usually has the public const uint TABSTOP style so that the user can move from group to group. The user can subsequently change the keyboard focus from one control in the group to the next control in the group by using the direction keys.
        ...
        /// <summary>The window has a maximize button. Cannot be combined with the public const uint EX_CONTEXTHELP style. The public const uint SYSMENU style must also be specified.</summary>
        public const uint MAXIMIZEBOX = 0x10000;

        /// <summary>The window is initially minimized.</summary>
        public const uint MINIMIZE = 0x20000000;

        /// <summary>The window has a minimize button. Cannot be combined with the public const uint EX_CONTEXTHELP style. The public const uint SYSMENU style must also be specified.</summary>
        ...
        /// Pressing the TAB key changes the keyboard focus to the next control with the public const uint TABSTOP style.  
        /// You can turn this style on and off to change dialog box navigation. To change this style after a window has been created; use the SetWindowLong function.
