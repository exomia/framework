...
namespace Exomia.Framework.Win32
{
    static class WSEX
    {
        ...
        /// </summary>
        /// <remarks>
        /// With public const uint COMPOSITED set; all descendants of a window get bottom-to-top painting order using double-buffering.
        /// Bottom-to-top painting order allows a descendent window to have translucency (alpha) and transparency (color-key) effects;
        /// but only if the descendent window also has the public const uint TRANSPARENT bit set.
        ...
        /// public const uint CONTEXTHELP cannot be used with the WS_MAXIMIZEBOX or WS_MINIMIZEBOX styles.
        /// </summary>
        ...
        /// The window does not appear on the taskbar by default. To force the window to appear on the taskbar; use the public const uint APPWINDOW style.
        ...
        /// The shell language must support reading-order alignment for this to take effect.
        /// Using the public const uint RIGHT style has the same effect as using the SS_RIGHT (static); ES_RIGHT (edit); and BS_RIGHT/BS_RIGHTBUTTON (button) control styles.
        /// </summary>
