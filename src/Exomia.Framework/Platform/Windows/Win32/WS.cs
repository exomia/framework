...
namespace Exomia.Framework.Platform.Windows.Win32
{
    static class WS
    {
        ...
        ///     the public const uint POPUP style.
        /// </summary>
        ...
        ///     the public const uint CLIPSIBLINGS style clips all other overlapping child windows out of the region of the child
        ///     window to be updated.
        ///     If public const uint CLIPSIBLINGS is not specified and child windows overlap; it is possible; when drawing within
        ...
        ///     defined after it; up to the next control with the public const uint GROUP style.
        ///     The first control in each group usually has the public const uint TABSTOP style so that the user can move from
        ///     group to group. The user can subsequently change the keyboard focus from one control in the group to the next
        ...
        /// <summary>
        ///     The window has a maximize button. Cannot be combined with the public const uint EX_CONTEXTHELP style. The
        ///     public const uint SYSMENU style must also be specified.
        /// </summary>
        ...
        /// <summary>
        ///     The window has a minimize button. Cannot be combined with the public const uint EX_CONTEXTHELP style. The
        ///     public const uint SYSMENU style must also be specified.
        /// </summary>
        ...
        /// <summary>
        ///     The window is a pop-up window. The public const uint CAPTION and public const uint POPUPWINDOW styles must be
