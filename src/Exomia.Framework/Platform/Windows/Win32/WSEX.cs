...
namespace Exomia.Framework.Platform.Windows.Win32
{
    static class WSEX
    {
        ...
        /// </summary>
        /// <remarks>
        ///     With public const uint COMPOSITED set; all descendants of a window get bottom-to-top painting order using
        ///     double-buffering.
        ...
        ///     The window does not appear on the taskbar by default. To force the window to appear on the taskbar; use the public
        ///     const uint APPWINDOW style.
        ...
        ///     The shell language must support reading-order alignment for this to take effect.
        ///     Using the public const uint RIGHT style has the same effect as using the SS_RIGHT (static); ES_RIGHT (edit); and
