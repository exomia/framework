...
{
    /// <summary>
    ///     A sprite font 2. This class cannot be inherited.
    /// </summary>
    ...
    public sealed class SpriteFont2 : IDisposable
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="SpriteFont2" /> class.
        /// </summary>
        public SpriteFont2()
        {
        ...
        /// <summary>
        ///     Finalizes an instance of the <see cref="SpriteFont2" /> class.
        /// </summary>
        ~SpriteFont2()
        {
            Dispose(false);
        ...
        ///     Draw font.
        /// </summary>
        /// <param name="texture2">        The second texture. </param>
                    ...
                    default:
                        {
                            ...
                            drawCallback(
                                _texture2, new Vector2(position.X + x + dx, position.Y + y + glyph.OffsetY),
                                glyph.Subrect,
        ...
        /// <summary>
        ///     Releases the unmanaged resources used by the Exomia.Framework.Graphics.SpriteFont2 and
